...
public class LoadingPage extends javax.swing.JFrame implements Runnable {//İnterface Kulllanımı
    ...
    private final int durdurma=103;//Final Tanımlama
    @Override//Override Ederek İçeriğinin Değiştirilmesi
    public void run() {
